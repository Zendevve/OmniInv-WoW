...
L["Sort Right to Left"] = "Sort Right to Left"
L["Sort bags from right to left instead of left to right"] = "Sort bags from right to left instead of left to right"
L["Merge"] = "Merge"
L["Group:"] = "Group:"
L["Mark:"] = "Mark:"
L["Any rule"] = "Any rule"
...
if locale == "zhCN" then
    ...
    L["Sort Right to Left"] = "从右到左排序"
    L["Sort bags from right to left instead of left to right"] = "从右到左排序背包,而不是从左到右。"
    L["Edit"] = "编辑"
    L["Save"] = "保存"
    L["Cancel"] = "取消"
    L["+ Add Category"] = "+ 添加分类"
...
elseif locale == "esES" then
    ...
    L["Sort Right to Left"] = "Ordenar de derecha a izquierda"
    L["Sort bags from right to left instead of left to right"] = "Ordena las bolsas de derecha a izquierda en lugar de izquierda a derecha."
    L["Edit"] = "Editar"
    L["Save"] = "Guardar"
    L["Cancel"] = "Cancelar"
...
elseif locale == "ptBR" then
    ...
    L["Sort Right to Left"] = "Ordenar da direita para a esquerda"
    L["Sort bags from right to left instead of left to right"] = "Ordena as bolsas da direita para a esquerda em vez de da esquerda para a direita."
    L["Edit"] = "Editar"
    L["Save"] = "Salvar"
    L["Cancel"] = "Cancelar"
...
elseif locale == "deDE" then
    ...
    L["Sort Right to Left"] = "Von rechts nach links sortieren"
    L["Sort bags from right to left instead of left to right"] = "Sortiert die Taschen von rechts nach links statt von links nach rechts."
    L["Edit"] = "Bearbeiten"
    L["Save"] = "Speichern"
    L["Cancel"] = "Abbrechen"
...
elseif locale == "ruRU" then
    ...
    L["Sort Right to Left"] = "Сортировка справа налево"
    L["Sort bags from right to left instead of left to right"] = "Сортирует сумки справа налево вместо слева направо."
    L["Edit"] = "Изменить"
    L["Save"] = "Сохранить"
    L["Cancel"] = "Отмена"
